		...
		<div id="list-task" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="state" title="${message(code: 'task.state.label', default: 'State')}" />
					
						<g:sortableColumn property="finished" title="${message(code: 'task.finished.label', default: 'Finished')}" />
					
						<th><g:message code="task.customer.label" default="Customer" /></th>
				...
				<g:each in="${taskInstanceList}" status="i" var="taskInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${taskInstance.finished}" /></td>
					
						<td>${fieldValue(bean: taskInstance, field: "customer")}</td>
