		...
		<div id="list-comment" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="comment.sender.label" default="Sender" /></th>
					
						<th><g:message code="comment.receiver.label" default="Receiver" /></th>
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${commentInstance.id}">${fieldValue(bean: commentInstance, field: "sender")}</g:link></td>
					
						<td>${fieldValue(bean: commentInstance, field: "receiver")}</td>
